    ...
    <div id="ai-panel">
      ...
      <div id="ai-body">
        <div id="ai-placeholder">
          ...
          <div style="font-size:12px">Click "Analyze with AI" to get an automated review of all changes in this merge request using the AI model configured in settings.</div>
        </div>
